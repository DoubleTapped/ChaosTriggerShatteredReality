...
{
    class darkPlayerFutureSpriteAnimationControll
    {
        ...
        public darkPlayerFutureSpriteAnimationControll(Texture2D textureAttack, int atkRows, int atkColumns, Texture2D textureWalkRight, int walkRightRows, int walkRightColumns, Texture2D textureWalkLeft, int walkLeftRows, int walkLeftColumns, Texture2D textureAttack2, int atkRows2, int atkColumns2)
        {
